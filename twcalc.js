...
tsalkapone_trans.greek= {
	 general:{
	 script:"Calculadora de Distância e Tempo",
	 notification:"Notificação de",
            selected_one:"Idioma atualmente selecionado",
            available:"Ididomas disponíveis‚",
			button_list:"Lista de Botões",
			lang_sel:"Clique para selecionar o idioma",
			message_no:"Não",
		message_yes:"Sim",
		message_1:"Este script é ativado em Visualizações - > Combinado",
		message_2:"Quer atribuir automaticamente a sua localização a esta página?",
		comm:"Sinta-se à vontade para enviar qualquer mensagem sobre bugs de script ou propor ideias para",
		des:"Descrição da função",
		but:"Botões",
		edited_by:"EEditado por",
		created:"Criado por",
		set_list:"Configurações & Funções",
		res_list:"Configurações do Script",
		blank:"Clique no botão de qualquer script para exibir suas configurações e valores",
		script_1:"Calcule a distância entre duas aldeias",
		script_2:"Calcule o tempo de retorno de um comando",
		script_3:"Calcule o tempo de snipe em um comando de retorno",
		script_4:"Calcule 0 tempo de snipe em um comando",
		script_5:"Abra a Calculadora de Tempo em uma nova guia",
		script_6:"Calcule os campos máximos necessários para cada unidade atingir a duração escolhida",
		send:"Enviar",
		vil_from:"de",
		vil_to:"para",
		lau:"on",
		speed:"Velocidade da unidade",
		amount:"Quantidade",
		ori:"Origem",
		dest:"Destino",
		lau_time:"Hora dee envio",
		list_form:"Tempo dos Snipes em lista",
		tab_form:"Tempo dos Snipes em tabela",
		attention:"ATENÇÃO: Note que às vezes o horário do servidor que é mostrado na tela tem atraso de 1 segundo. Neste caso subtraia 1 segundo de cada resultado de tempo",
		vil1:"Origem",
		vil2:"Destino",
		dur:"Duração",
		tsal_apply:"Aplicar",
		tsal_search:"Calcular",
		tsal_speed:"Velocidade",
		spear:"Lanceiro",
		sword:"Espadachim",
		axe:"Bárbaro",
		archer:"Arqueiro",
		...
		knight:"Paladino",
		snob:"Nobre",
		tsal_time:"Hora de chegada",
		tsal_target:"Aldeia-alvo",
		tsal_unit:"Unidade mais lenta",
		tsal_dur:"Duração",
		tsal_error:"Erro",
		tsal_notime:"Nenhuma aldeia pode alcançar a meta no tempo de chegada especificado",
		info1:"Insira as coordenadas da aldeia de origem",
		info2:"Insira as coordenadas da aldeia de destino",
		info3:"Digite a hora de chegada do comando à aldeia de destino. Insira as 3 primeiras letras do mês em inglês, o dia do mês, o ano e a hora: minutos: segundos da hora de chegada",
		info4:"Digite a unidade mais lenta do comando da aldeia de origem. Se você não rotulou o comando, escolha uma unidade aleatória. Se você não tiver certeza sobre sua escolha, abandone o comando de snipe no tempo anterior.",
		info5:"Insira as coordenadas da aldeia-alvo.",
		info6:"Marque uma caixa ao lado de um tipo de unidade para incluir sua velocidade no cálculo de tempos do snipe. Desmarque para excluí-lo.",
		info7:"Insira uma duração no seguinte formato hh: mm: ss (horas: minutos: segundos)",
	},
	buttons:{
			  lang_open:"Abrir seleção de idioma",
              lang_close:"Fechar seleção de idioma",
			  script_1:"Calculadora de distância",
		script_2:"Calculadora de retorno",
		script_3:"Snipe de retorno",
		script_4:"Calculadora de snipe",
		script_5:"Calculadora de tempo",
		script_6:"Calculadora de campos",
		show_results:"Mostrar resultados",
		hide_results:"Ocultar resultados",
		tsal_info:"Informações e dicas",
	},
	notes:{
		activated:"O script Calculadora de tempo e distância já está ativo",
		tsal_notime:"Nenhuma aldeia pode alcançar a meta no tempo de chegada especificado",
	},
};
...
function fnInjectOverviewBar(){
	...
	fnInjectUnits();
	var lang_img='';
        if (lang=="greek") {lang_img ='<img title="Î•Î»Î»Î·Î½Î¹ÎºÎ¬" style="cursor:help;" height="20px" width="30px" src="https://dl.dropboxusercontent.com/s/ivyojb6w9cb9pem/flag_greece.gif">';}
...
try{
	if(document.getElementById('combined_table'))
	{
		...
		if(ver!=="Tsalkapone"){
			alert("Î¤Î¿ ÏƒÏ…Î³ÎºÎµÎºÏÎ¹Î¼Î­Î½Î¿ script Î±Ï€Î±Î¹Ï„ÎµÎ¯ Î­ÎºÎ´Î¿ÏƒÎ· v"+minVer+" Î® Î¼ÎµÎ³Î±Î»ÏÏ„ÎµÏÎ·.\nÎ§ÏÎ·ÏƒÎ¹Î¼Î¿Ï€Î¿ÎµÎ¯Ï„Îµ Ï„Î·Î½ Î­ÎºÎ´Î¿ÏƒÎ·: v"+ver[1]);
		}
